public class TennisGame {
    ...
    public String score(int player1Points, int player2Points) {
        if (isNotValidPoints(player1Points, player2Points))
    ...
    private boolean isNotValidPoints(int player1Points, int player2Points) {
        return !isValidPoints(player1Points, player2Points);
    }
